...
export default async function Home() {
  ...
  return (
    <>
      <div className="main pt-24 justify-center join flex bg-base-100 text-black">
        <div className="mr-4">
      ...
      <div className="output h-24 pt-10 w-screen text-center bg-base-100" id="output"></div>
    </>
  )
}
